...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        cameraParent.GetComponentInChildren<CinemachineCamera>().Lens.FieldOfView = fov;
    }
    ...
    void Boost(bool state)
    {
        ...
        DOVirtual.Float((float)dolly.SplinePosition, speed, .15f, SetSpeed);
